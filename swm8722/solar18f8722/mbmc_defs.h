...
#define DUAL_CV_LOW	14000ul		// stop voltage
#define DUAL_CV_BSOC	80		// SOC discharge level for dual charging
...
#define	CHRG_HIGH	20000ul   	// max voltage while in a charge cycle to have charger on.
