...
${OBJECTDIR}/_ext/1472/pat.o: ../pat.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) --verbose -I"../C:/Program Files (x86)/Microchip/mplabc18/v3.38/h" -I".." -I"." -ml -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1472/pat.o   ../pat.c 
...
${OBJECTDIR}/_ext/1472/blinker.o: ../blinker.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) --verbose -I"../C:/Program Files (x86)/Microchip/mplabc18/v3.38/h" -I".." -I"." -ml -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1472/blinker.o   ../blinker.c 
