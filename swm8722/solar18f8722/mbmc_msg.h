...
lowbatt0[] = "\n\r Reducing battey Ah rating due to possible discharged battery.\n\r",
		...
		battheader0[] = " # CI  mV B1  mV B2  mVSOC    Ah    mAhir    mAhi    mAho      Wi      Wo  DOD  BSOC  RSOC    RUN  Weight  CESR   LESR\n\n\r",
		battheader1[] = " #     LDE    LDC     AD    ACC    FCC    FDC   AHUP  MINBV  MAXBV    AHUR   KWHIN  KWHOUT  CEF  CEF_CAL CEF_SAV BS_AHU AHIR  BS_AHI  BS_AHO  CEF_RAW\n\n\r",
...
chrgcode0[] = " C0  Charging stopped, Battery overvolt limit.\r\n",
		...
		charger1[] = "\n\r \x1b[7mC18 Inverter battery low, BATTERY PROTECTION UNDER LOAD, charger relay switched on.\x1b[0m \n\r",
