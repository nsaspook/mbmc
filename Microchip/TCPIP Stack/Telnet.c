...
static ROM BYTE strAuthenticated[] = "\r\n Logged in successfully\r\n\r\n"
	"\r\nPress '.' or ESC to quit\r\n";
// Demo output string
static ROM BYTE strDisplay[] = "\r\n Connected to MBMC Controller. \r\n";
// String with extra spaces, for Demo
static ROM BYTE strSpaces[] = "          ";
// Demo disconnection message
static ROM BYTE strGoodBye[] = "\r\n\r\n Goodbye!\r\n";

// exit hoststat printf format
static ROM char strHostStat[] = " Logins %li, Rx data %li, Tx data %li\r\n";

extern BYTE AN0String[8];
extern volatile struct hoststattype hoststat;
