...
lowbatt0[] = "\n\r Reducing battey Ah rating due to possible discharged battery.\n\r",
	...
	battheader2[] = " #     0.1A   0.1A   0.1A     Battery Cycles    0.1A  Battery Volts   0.1A    0.1 WattHour  Charge efficency     Program Data Factors\n\n\r",
...
chrgcode0[] = " C0  Charging stopped, Battery overvolt limit.\r\n",
	...
	charger1[] = "\n\r \x1b[7mC18 Inverter battery low WEIGHT, BATTERY PROTECTION UNDER LOAD, charger relay switched on.\x1b[0m \n\r",
